        ...
        return(
            <div className="home">
                <div className="intro-box">
                    ...
                    <div className="vl">
                        <h1 className="header-text">Hi! My name is Emily Cheng, and I'm a rising junior at MIT studying Mathematics and Computer Science. Some of my interests include volleyball, product management, cooking and eating, and traveling. <br></br> <br></br> Welcome to the soft launch of my personal website! </h1>
                        <div className="links">
